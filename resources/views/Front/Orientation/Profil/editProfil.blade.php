                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                        ...
                                        <form action="{{route('profil.Front.update', $user)}}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-file-container bg-info">
                                                            ...
                                                            <label style="background-color: #7367f0;" for="my-file" class="input-file-trigger" tabindex="0">
                                            ...
                                            <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                                                    <button type="submit" class="btn btn-primary glow mb-1 mb-sm-0 mr-0 mr-sm-1" style="border-radius: 0.4285rem; margin-right: 1rem !important;border: 0 solid transparent;" >Enregistrer</button>
                                                    <button type="reset" class="btn btn-outline-warning" style="border: none;" >Reset</button>
                                                </div>
                                        </form>
