                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form method="post"  action="{{ route('school.create')}}" class="steps-validation wizard-circle" enctype="multipart/form-data">
                                            @csrf
                                            @method('GET')
                                            <!-- Step 1 -->
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="">
                                                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Nom" required value="{{ old('name') }}"/>
                                                                    @error('name')
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="localisation" id="localisation">
                                                                    @foreach ($villes as $ville)
                                                                        <option value="{{$ville->name}}" row="5">{{$ville->name}}</option>                                                                        
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div> 
                                            ...
                                            <!-- Step 2 -->
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="">
                                                                <textarea type="description" class="form-control @error('description') is-invalid @enderror" id="description" name="description" required placeholder="description" value="{{ old('description')}}" cols="50" rows="30"></textarea>
                                                                @error('description')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                ...
                                                <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">   
                                                    <button type="submit" class="btn btn glow mb-1 mb-sm-0 mr-0 mr-sm-1 btn-lg" style="background-color: #106eea;color:white;" id="" style="height: 40px;" value="Sign up">Enregistrer</button>             
