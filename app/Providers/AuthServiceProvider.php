...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Gate::define('profil-utilisateur', function ($user) {
            return $user->hasAnyRole(['Utilisateur']);
        });
        ...
        Gate::define('users', function ($user) {
            return $user->hasAnyRole(['admin' , 'Superviseur', 'Utilisateur']);//on va donc utilisé ce gate dans note route, c'est ici qu'on decide qui aura accé a notre page admin
        });
    }
}
